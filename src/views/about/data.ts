...
export const coreProjects: ProjectItem[] = [
  ...
  {
    name: 'MachTable Vue',
    bagName: '@agile-team/mach-table-vue',
    desc: 'MachTable 企业级虚拟化数据网格的官方 Vue 3 适配层',
    shortDesc: '虚拟化表格',
    version: '0.29.2',
    icon: 'https://raw.githubusercontent.com/ChenyCHENYU/MachTable/main/assets/mach-table-logo.svg',
    url: 'https://www.npmjs.com/package/@agile-team/mach-table-vue',
  },
  {
    name: 'UnoCSS',
    bagName: 'unocss',
...
export const productionDependencies: ProjectItem[] = [
  {
    name: 'MachTable Vue',
    bagName: '@agile-team/mach-table-vue',
    desc: '框架无关 MachTable Core 的官方 Vue 3 适配层',
    version: '0.29.2',
    icon: 'https://raw.githubusercontent.com/ChenyCHENYU/MachTable/main/assets/mach-table-logo.svg',
    url: 'https://www.npmjs.com/package/@agile-team/mach-table-vue',
  },
